    ...
    <div className="space-y-6">
      ...
      <div className="neo-card p-4">
        <div className="flex items-center justify-between mb-3">
          <h4 className="font-bold text-sm uppercase flex items-center gap-2 text-charcoal tracking-[0.08em]">
        ...
        <div>
          <label className="text-xs font-mono text-charcoal block mb-1 font-semibold">
          ...
          />
          <div className="flex justify-between text-[10px] font-mono text-charcoal mt-1 font-semibold">
            <span>10%</span>
            <span>50%</span>
            <span>90%</span>
          </div>
        ...
        <p className="mt-3 text-xs font-mono text-charcoal leading-relaxed">
          {t.agri.aiModelDesc}
        </p>
      </div>
        ...
        >
          {result && outputUrl ? (
              ...
              {summary && (
                <div className="mt-4 space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-2.5">
                    <div className="neo-card-teal frosted-module p-3 text-center">
                      <p className="text-2xl font-black text-orange-neon">
                        {summary.totalCount}
                      </p>
                      <p className="text-[11px] font-bold uppercase tracking-[0.1em] text-charcoal">
                        {t.agri.objectsFound}
                      </p>
                    </div>
                    <div className="neo-card-teal frosted-module p-3 text-center">
                  ...
                  <div className="neo-card p-3">
                    <p className="text-xs font-black uppercase tracking-[0.1em] text-charcoal mb-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {Object.entries(summary.classCounts)
                        ...
                        .map(([cls, count]) => (
                          <span
                            key={cls}
                            className="px-2 py-1 bg-white/78 text-charcoal text-xs font-semibold font-mono neo-border"
                          >
                            {cls}: {count}
                          </span>
                        ))}
                  ...
                  <details className="neo-card">
                    <summary className="p-3 cursor-pointer text-xs font-black uppercase tracking-[0.1em] text-charcoal">
                    ...
                    <div className="p-3 pt-0 max-h-40 overflow-y-auto space-y-1">
                      {result.detections.map((det, i) => (
                        ...
                        >
                          <span className="font-bold text-charcoal">{det.class}</span>
            ...
            <div className="text-center py-12 text-charcoal">
              <Brain className="w-12 h-12 mx-auto mb-3 opacity-45" />
              <p className="font-mono text-sm font-semibold">{t.agri.aiPlaceholder}</p>
              <p className="font-mono text-[10px] mt-1 text-charcoal-light">
