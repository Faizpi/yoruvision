  ...
  return (
    <div className="space-y-6">
      ...
      <div className="neo-card p-4">
        <h4 className="font-bold text-sm uppercase mb-3 tracking-[0.08em] text-charcoal">{t.agri.parameters}</h4>
            ...
            <div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="neo-card-teal frosted-module p-3 text-center">
                  ...
                  <p className="text-xs font-mono font-bold uppercase tracking-[0.1em] text-charcoal">{t.agri.objectsFound}</p>
                </div>
                <div className="neo-card p-3 text-center">
                  <p className="text-sm font-mono text-charcoal font-semibold">
...
export function CoinPanel() {
  ...
  return (
    <div className="space-y-6">
      {/* Controls */}
      <div className="neo-card p-4">
        <h4 className="font-bold text-sm uppercase mb-3 tracking-[0.08em] text-charcoal">{t.agri.circleParams}</h4>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="text-xs font-mono text-charcoal block mb-1 font-semibold">
        ...
        >
          {result && outputUrl ? (
            <div>
              ...
              <div className="mt-4 neo-card-teal frosted-module p-4 text-center">
                <p className="text-4xl font-black text-mint">{result.count}</p>
                <p className="text-sm font-mono font-bold uppercase tracking-[0.1em] text-charcoal">{t.agri.coinsDetected}</p>
              </div>
            </div>
          ) : (
            <div className="text-center py-12 text-charcoal-light">
