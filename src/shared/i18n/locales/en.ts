const en = {
  ...
  /* ── Landing / Home ─────────────────────────────── */
  home: {
    badge: "Yoru Vision Suite — 2026",
    heroDesc:
      "Comprehensive digital image processing lab with <accent>12 interactive modules</accent>: steganography, smart agriculture AI, OCR text recognition, enhancement advisor, image forensics, histogram analysis, color space conversion, edge detection, convolution filters, morphology, FFT frequency processing, and geometric transforms. Everything runs browser-native with no backend upload.",
    overviewDesc:
      "Yoru Vision combines scientific image processing workflows with fast browser execution. Explore 12 integrated modules for analysis, enhancement, forensic inspection, and AI-assisted detection in one consistent interface.",
    ...
    modulesSubheading:
      "Open each module with a unified interface while preserving the original image-processing engine and workflow behavior.",
    statModulesLabel: "Modules",
    statBackendLabel: "Backend",
    statBrowserNativeLabel: "Browser-Native",

    /* tech stack */
    techNextjs: "Next.js",
    techNextjsDesc: "App Router",
    techTailwind: "Tailwind CSS",
    techTailwindDesc: "Custom Frosted UI",
  ...
  /* ── Footer ─────────────────────────────────────── */
  footer: {
    credit: "Yoru Vision by Muhammad Faiz Bintang Pratama",
