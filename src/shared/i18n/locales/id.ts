...
const id: TranslationKeys = {
  ...
  home: {
    ...
    heroDesc:
      "Laboratorium pengolahan citra digital yang lengkap dengan <accent>12 modul interaktif</accent>: steganografi, AI pertanian cerdas, OCR pengenalan teks, enhancement advisor, forensik gambar, analisis histogram, konversi ruang warna, deteksi tepi, filter konvolusi, morfologi, pemrosesan frekuensi FFT, dan transformasi geometri. Seluruh proses berjalan native di browser tanpa upload ke backend.",
    overviewDesc:
      "Yoru Vision menghadirkan alur kerja pengolahan citra yang ilmiah sekaligus cepat di browser. Tersedia 12 modul terintegrasi untuk analisis, enhancement, inspeksi forensik, dan deteksi berbasis AI dalam antarmuka yang konsisten.",
    ...
    modulesSubheading:
      "Buka setiap modul dengan antarmuka yang seragam, sambil mempertahankan engine dan perilaku workflow pemrosesan citra aslinya.",
    statModulesLabel: "Modul",
    statBackendLabel: "Backend",
    statBrowserNativeLabel: "Native Browser",

    /* tech stack */
    techNextjs: "Next.js",
    techNextjsDesc: "App Router",
    techTailwind: "Tailwind CSS",
    techTailwindDesc: "UI Frosted Kustom",
  ...
  /* ── Footer ─────────────────────────────────────── */
  footer: {
    credit: "Yoru Vision oleh Muhammad Faiz Bintang Pratama",
